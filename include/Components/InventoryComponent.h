...
class InventoryComponent {
   public:
    ...
    /**
     * @brief Creates a blueprint-style clone: a fresh component with default runtime fields and a
     * new id.
     *
    ...
    // Serialization hooks (JSON text). Implementations should return a JSON string representing the
    // object.
