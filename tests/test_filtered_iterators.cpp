...
TEST_SUITE("Filtered Iterator Examples") {
    TEST_CASE("Filter 1: Only Plants (exclude Groups)") {
        ...
        auto filteredStrategy = std::make_unique<FilteredTraversal>(
            std::make_unique<PreOrderTraversal>(), plantsOnlyFilter);
    ...
    TEST_CASE("Filter 2: Only Roses") {
        ...
        auto filteredStrategy = std::make_unique<FilteredTraversal>(
            std::make_unique<PreOrderTraversal>(), rosesOnlyFilter);
    ...
    TEST_CASE("Filter 3: Only Cacti") {
        ...
        auto filteredStrategy = std::make_unique<FilteredTraversal>(
            std::make_unique<PreOrderTraversal>(), cactiOnlyFilter);
    ...
    TEST_CASE("Filter 4: Works with Different Base Strategies") {
        ...
        auto preOrderStrategy =
            std::make_unique<FilteredTraversal>(std::make_unique<PreOrderTraversal>(), rosesFilter);
        ...
        auto levelOrderStrategy = std::make_unique<FilteredTraversal>(
            std::make_unique<LevelOrderTraversal>(), rosesFilter);
    ...
    TEST_CASE("Filter 5: Empty Results When Nothing Matches") {
        ...
        auto filteredStrategy =
            std::make_unique<FilteredTraversal>(std::make_unique<PreOrderTraversal>(), cactiFilter);
